...
public class TestAddCart {
    ...
    public void testAddCart() {
        delay(2);
        addCart.setAddToCart();
        Assert.assertTrue(addCart.getNotifySuccessAddCart().contains("“playboy x missguided plus size grey lips print front cropped t shirt” has been added to your cart"));
